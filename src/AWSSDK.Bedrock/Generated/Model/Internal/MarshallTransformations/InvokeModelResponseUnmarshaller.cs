...
{
    /// <summary>
    /// Response Unmarshaller for InvokeModel operation
    /// </summary>  
    public class InvokeModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static InvokeModelResponseUnmarshaller _instance = new InvokeModelResponseUnmarshaller();        

        internal static InvokeModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InvokeModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
