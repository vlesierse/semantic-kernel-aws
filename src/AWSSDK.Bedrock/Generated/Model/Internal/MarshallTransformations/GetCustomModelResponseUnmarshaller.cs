    ...
    public class GetCustomModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = FineTuningHyperParametersUnmarshaller.Instance;
                ...
                if (context.TestExpression("realTimeInferenceStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RealTimeInferenceStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
