...
{
    /// <summary>
    /// Response Unmarshaller for InvokeModelWithResponseStream operation
    /// </summary>  
    public class InvokeModelWithResponseStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InvokeModelWithResponseStreamResponse response = new InvokeModelWithResponseStreamResponse();
        ...
        private static InvokeModelWithResponseStreamResponseUnmarshaller _instance = new InvokeModelWithResponseStreamResponseUnmarshaller();        

        internal static InvokeModelWithResponseStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InvokeModelWithResponseStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
