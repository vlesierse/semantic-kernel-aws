...
namespace Amazon.Bedrock.Model
{
    ...
    [Serializable]
    #endif
    public partial class ModelErrorException : AmazonBedrockException
    {
        ...
        public ModelErrorException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ModelErrorException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
