...
namespace Amazon.Bedrock.Model
{
    ...
    public sealed class ResponseStream : EnumerableEventStream<IEventStreamEvent, BedrockEventStreamException>
    {
        ///summary>
        ...
        /// </summary>
        protected override IDictionary<string,Func<IEventStreamMessage,BedrockEventStreamException>> ExceptionMapping {get;} =
        new Dictionary<string,Func<IEventStreamMessage,BedrockEventStreamException>>
        {
        };
        ...
        public override event EventHandler<EventStreamExceptionReceivedArgs<BedrockEventStreamException>> ExceptionReceived;
        ///<summary>
        ...
        public ResponseStream(Stream stream, IEventStreamDecoder eventStreamDecoder) : base(stream, eventStreamDecoder)
        {
            ...
            Decoder.MessageReceived += (sender, args) =>
            {
                ...
                var _ = RaiseEvent(ChunkReceived, ev);
            };       
        }
